...
@Component
public class ObtenirEmpleatsDelParametre {

    @Autowired
    ParametreRepository parametreRepo;

    public List<EmpleatParametre> executar(String nomAplicacio, String nomParametre) {
        return parametreRepo.listEmpleatDelParametre(nomAplicacio, nomParametre);
    }
}