...
@JsonDeserialize(builder = CalculComandaNormalitzatResponseImpl.Builder.class)
@Value.Style(typeImmutable = "*Impl")
@Value.Immutable
public interface CalculComandaNormalitzatResponse {
	...
	static CalculComandaNormalitzatResponse empty(){
