...
import ames.comercial.comandes.internal.application.query.GenerarPdfJustificantComandaEspecial;
...
import ames.comercial.comandes.request.EnviarJustificantRecepecioEspecialRequest;
...
@Component
public class EnviarJustificantRecepcioComandaEspecial {

    final ComandaRepository comandaRepository;
    final GenerarPdfJustificantComandaEspecial generarPdfJustificantComandaEspecial;
    ...
    public EnviarJustificantRecepcioComandaEspecial (ComandaRepository comandaRepository, GenerarPdfJustificantComandaEspecial generarPdfJustificantComandaEspecial,
        ...
        this.generarPdfJustificantComandaEspecial = generarPdfJustificantComandaEspecial;
    ...
    public void executar (long codiComanda, EnviarJustificantRecepecioEspecialRequest request, Map<String, InputStream> fitxersAdjunts) {
        ...
        var pdfJustificant = generarPdfJustificantComandaEspecial.run(codiComanda, request.idioma(), request.formatNumeric(), request.tipus());
