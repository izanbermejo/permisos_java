...
@Service
public class ObtenirDetallComandesClient {

    @Autowired @Qualifier("jdbcAmes")
    JdbcTemplate jdbcAmes;

    public List<ObtenirDetallComandesClientResponse> executar(String client, LocalDate dataInici, LocalDate dataFi, boolean mostrarEliminades) {
        ...
        return new NamedParameterJdbcTemplate(jdbcAmes).query("""
                    ...
                    SELECT l.comanda, l.numero, c.informacio_client->>'identificador' AS identificador_client, l.tipus, ac.codi_fabrica,
                ...
                """,
                params,
                this::mapAllDetallComandesClient
        );
    }

    private ObtenirDetallComandesClientResponse mapAllDetallComandesClient(ResultSet rs, int rowNum) throws SQLException {
        return ObtenirDetallComandesClientResponseImpl.builder()
    ...
    @JsonDeserialize(builder = ObtenirDetallComandesClientResponseImpl.Builder.class)
    @Value.Style(typeImmutable = "*Impl")
    @Value.Immutable
    public interface ObtenirDetallComandesClientResponse {
        long comandaAMES();
        long numero();
