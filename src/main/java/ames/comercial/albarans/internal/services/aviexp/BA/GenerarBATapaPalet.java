...
public class GenerarBATapaPalet extends GenerarBA {

    public GenerarBATapaPalet(ElementEmbalatgeExpedicio embalatgeExpedicio, AcumulatAviExp acumulatAviExp, BigDecimal pesPesa) {
    ...
    @Override
    protected BigDecimal calcularPesNet() { return BigDecimal.ZERO;}

    @Override
    protected BigDecimal calcularPesBrut() { return BigDecimal.ZERO;}
