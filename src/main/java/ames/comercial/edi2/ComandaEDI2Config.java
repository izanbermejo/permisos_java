...
@Component
public class ComandaEDI2Config {

    @Value("${docsapps-folder}") private String rootDirectory;

    private final String APP_DIRECTORY = "/comercial/edis_indra";

    public String getDirIN() {return rootDirectory+APP_DIRECTORY+"/in";}

    public String getDirBKP() {return rootDirectory+APP_DIRECTORY+"/bkp";}

    public String getDirERROR() {return rootDirectory+APP_DIRECTORY+"/err";}
