...
@Service
public class ObtenirComandesEDI2ByMissatge {
    @Autowired
    NamedParameterJdbcTemplate jdbc;

    public List<JSONObject> executar(String codiMissatge) {
        var params = new MapSqlParameterSource();
        params.addValue("codiMissatge", codiMissatge, Types.INTEGER);
        return jdbc.query("""
                        SELECT ca.ca->>'documento' as tipus, i.datareg as dataArribada, co.la->>'idArticuloComprador' as referenciaClient,
                            ...
                            co.lc->>'codigoConsignatario' as plantaClient
